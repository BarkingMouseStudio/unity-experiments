...
namespace RootMotion.Demos {
	...
	/// </summary>
	[RequireComponent(typeof(OVRInteractionController))]
	public class OVRInteractionUI : MonoBehaviour {
		...
		private OVRInteractionController interactionController;
		private Image[] sliderImages;
		private const string showCursorTag = "ShowCursor";
		
		void Start() {
			interactionController = GetComponent<OVRInteractionController>();
