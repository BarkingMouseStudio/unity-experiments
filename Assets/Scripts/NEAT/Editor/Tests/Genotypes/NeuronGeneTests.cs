...
namespace NEAT {
  ...
  public class NeuronGeneTests {
    ...
    public void TestNeuronGene_ToJSON() {
      ...
      var expected = "{\"innovation\":3,\"a\":0.1,\"b\":0.2,\"c\":0.3,\"d\":0.4}";
      Assert.AreEqual(expected, json);
    }

    [Test]
    public void TestNeuronGene_FromJSON() {
      var json = JSON.Deserialize("{\"innovation\":3,\"a\":0.1,\"b\":0.2,\"c\":0.3,\"d\":0.4}");
      var neuronGene = NeuronGene.FromJSON(json);
      var expected = new NeuronGene(3, 0.1f, 0.2f, 0.3f, 0.4f);
